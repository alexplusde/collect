...
class rex_cronjob_collect_places extends rex_cronjob
{
    ...
    {
        return rex_addon::get('collect')->i18n('collect_google_places');
    }
    public function getParamFields()
    {
        $fields[] = [
            'label' => rex_i18n::msg('collect_google_places_place_id'),
            'name' => 'place_id',
            'type' => 'text',
            'notice' => rex_i18n::msg('collect_google_places_place_id_notice'),
        ];
        $fields[] = [
            'label' => rex_i18n::msg('collect_google_places_api_key'),
            'name' => 'api_key',
            'type' => 'text',
            'notice' => rex_i18n::msg('collect_google_places_api_key_notice'),
        ];
        $fields[] = [
            'label' => rex_i18n::msg('collect_google_places_status'),
            'name' => 'status',
            'type' => 'text',
            'notice' => rex_i18n::msg('collect_google_places_status_notice'),
        ];
